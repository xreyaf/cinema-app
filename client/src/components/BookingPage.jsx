...
const BookingPage = () => {
  ...
  const getMovie = async () => {
    try {
      const res = await fetch(`https://cinema-appp.herokuapp.com/movies/${id}`, {
        method: 'GET',
        headers: { token: localStorage.token },
      });
  ...
  const getHallSchemeData = async () => {
    try {
      const res = await fetch(`https://cinema-appp.herokuapp.com/booking/${id}`, {
        method: 'GET',
        headers: { token: localStorage.token },
      });
  ...
  const getShowtime = async () => {
    try {
      const res = await fetch(`https://cinema-appp.herokuapp.com/booking/showtimes/${id}`, {
        method: 'GET',
        headers: { token: localStorage.token },
      });
  ...
  const updateHallScheme = async () => {
    try {
      ...
      await fetch(`https://cinema-appp.herokuapp.com/booking/hallschemes/${hallScheme.hallscheme_id}`, {
        method: 'PUT',
        headers: myHeaders,
